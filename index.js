...
app.listen(PORT, () => {
    ...
    console.log(color("> Rest api ini dibuat oleh ``Nekellalwayslus``",'white'))
    console.log(color("> Buy rest api no pasaran bisa beli di Nekellsadboy,",'white'))
    console.log(color("> Whatsapp :","red"), color("\n › no : 6289695073357\n › link : https://wa.me/6289695073357",'white'))
    console.log(color("> Instagram :","red"), color("\n › name : @nekell1337_\n › link : https://instagram.com/nekell1337_",'white'))
